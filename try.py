...
def show_main_app(userid):
    ...
    delete_est_btn = ttk.Button(addupdate_left_frame, text="Delete a Food Establishment", command=lambda: delete_food_establishment(userid, addupdate_right_frame), style="List.TButton", width=button_width)
    delete_est_btn.pack(pady=2, anchor="w", padx=1)

    update_est_btn = ttk.Button(addupdate_left_frame, text="Update a Food Establishment", command=lambda: update_food_establishment(userid, addupdate_right_frame), style="List.TButton", width=button_width)
    ...
    delete_item_btn = ttk.Button(addupdate_left_frame, text="Delete a Food Item", command=lambda: delete_food_item(userid, addupdate_right_frame), style="List.TButton", width=button_width)
    delete_item_btn.pack(pady=2, anchor="w", padx=1)

    update_item_btn = ttk.Button(addupdate_left_frame, text="Update a Food Item", command=lambda: update_food_item(userid, addupdate_right_frame), style="List.TButton", width=button_width)
